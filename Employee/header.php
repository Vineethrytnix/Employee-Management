        ...
        <div class="sidebar px-4 py-4 py-md-5 me-0">
            <div class="d-flex flex-column h-100">
                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li><a class="m-link" href="view_assigned_work.php"><i class="icofont-law-document"></i>
                            <span>Works</span></a></li>
                    <li><a class="m-link" href="view_attendance.php"><i class="icofont-finger-print"></i>
                    ...
                    <li><a class="m-link" href="view_payments.php"><i class="icofont-money"></i>
                            <span>Payments</span></a></li>
                    <li><a class="m-link" href="../login.php"><img src="../assets/images/switch.png" width="25px" alt="">
