                        ...
                        <div class="col-lg-8 col-md-12">
                            <div class="d-flex justify-content-center">
                                <table class="card p-5">
                                    <?php
                                    $qry = "SELECT `salary`.*,`employee`.* FROM `employee`,`salary` WHERE `salary`.`eid`=`employee`.`eid` AND `salary`.`eid`='$uid'";
                                                                    ...
                                                                    <tr>
                                                                        <td class="pt-2">
                                                                            <table class="table table-bordered">
                                                                                <tr>
                                                                                    <th colspan="2" class="text-start"><center>Date : <?php echo $row['date'] ?></center></th>
